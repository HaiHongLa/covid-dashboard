...
urlpatterns = [
    ...
    path('riskLevelsOverall/', views.TemplateView.as_view(template_name='riskLevels.overall.html'), name='riskLevelsOverall'),
    path('riskLevelsTestPositivityRatio/', views.TemplateView.as_view(template_name='riskLevels.testPositivityRatio.html'), name='riskLevelsTestPositivityRatio'),
    path('riskLevelsCaseDensity/', views.TemplateView.as_view(template_name='riskLevels.caseDensity.html'), name='riskLevelsCaseDensity'),
    path('riskLevelsCTCR/', views.TemplateView.as_view(template_name='riskLevels.contactTracerCapacityRatio.html'), name='riskLevelsCTCR'),
    path('riskLevelsInfectionRate/', views.TemplateView.as_view(template_name='riskLevels.infectionRate.html'), name='riskLevelsInfectionRate'),
    path('riskLevelsICU/', views.TemplateView.as_view(template_name='riskLevels.icuCapacityRatio.html'), name='riskLevelsICU'),
]